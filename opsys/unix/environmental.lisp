...
(define-to-list *sysconf-names*
  #(#(+SC-ARG_MAX+                       1)
    ...
    #(+SC-STREAM_MAX+                   26)
    #(+SC-TZNAME_MAX+                   27)
    #(+SC-ASYNCHRONOUS_IO+              28)
    #(+SC-PAGESIZE+                     29)
    #(+SC_PAGE_SIZE+                    29)
    #(+SC-MEMLOCK+                      30)
    #(+SC-MEMLOCK_RANGE+                31)
    #(+SC-MEMORY_PROTECTION+            32)
    #(+SC-MESSAGE_PASSING+              33)
    #(+SC-PRIORITIZED_IO+               34)
    #(+SC-PRIORITY_SCHEDULING+          35)
    #(+SC-REALTIME_SIGNALS+             36)
    #(+SC-SEMAPHORES+                   37)
    #(+SC-FSYNC+                        38)
    #(+SC-SHARED_MEMORY_OBJECTS+        39)
    #(+SC-SYNCHRONIZED_IO+              40)
    #(+SC-TIMERS+                       41)
    #(+SC-AIO_LISTIO_MAX+               42)
    #(+SC-AIO_MAX+                      43)
    #(+SC-AIO_PRIO_DELTA_MAX+           44)
    #(+SC-DELAYTIMER_MAX+               45)
    #(+SC-MQ_OPEN_MAX+                  46)
    #(+SC-MAPPED_FILES+                 47)
    #(+SC-RTSIG_MAX+                    48)
    #(+SC-SEM_NSEMS_MAX+                49)
    ...
    #(+SC-2_PBS+                        59)
    #(+SC-2_PBS_ACCOUNTING+             60)
    #(+SC-2_PBS_CHECKPOINT+             61)
    #(+SC-2_PBS_LOCATE+                 62)
    #(+SC-2_PBS_MESSAGE+                63)
    #(+SC-2_PBS_TRACK+                  64)
    #(+SC-ADVISORY_INFO+                65)
    #(+SC-BARRIERS+                     66)
    #(+SC-CLOCK_SELECTION+              67)
    #(+SC-CPUTIME+                      68)
    #(+SC-FILE_LOCKING+                 69)
    #(+SC-GETGR_R_SIZE_MAX+             70)
    #(+SC-GETPW_R_SIZE_MAX+             71)
    #(+SC-HOST_NAME_MAX+                72)
    #(+SC-LOGIN_NAME_MAX+               73)
    #(+SC-MONOTONIC_CLOCK+              74)
    #(+SC-MQ_PRIO_MAX+                  75)
    #(+SC-READER_WRITER_LOCKS+          76)
    #(+SC-REGEXP+                       77)
    #(+SC-SHELL+                        78)
    #(+SC-SPAWN+                        79)
    #(+SC-SPIN_LOCKS+                   80)
    #(+SC-SPORADIC_SERVER+              81)
    #(+SC-THREAD_ATTR_STACKADDR+        82)
    #(+SC-THREAD_ATTR_STACKSIZE+        83)
    #(+SC-THREAD_CPUTIME+               84)
    #(+SC-THREAD_DESTRUCTOR_ITERATIONS+ 85)
    #(+SC-THREAD_KEYS_MAX+              86)
    #(+SC-THREAD_PRIO_INHERIT+          87)
    #(+SC-THREAD_PRIO_PROTECT+          88)
    #(+SC-THREAD_PRIORITY_SCHEDULING+   89)
    #(+SC-THREAD_PROCESS_SHARED+        90)
    #(+SC-THREAD_SAFE_FUNCTIONS+        91)
    #(+SC-THREAD_SPORADIC_SERVER+       92)
    #(+SC-THREAD_STACK_MIN+             93)
    #(+SC-THREAD_THREADS_MAX+           94)
    #(+SC-TIMEOUTS+                     95)
    #(+SC-THREADS+                      96)
    #(+SC-TRACE+                        97)
    #(+SC-TRACE_EVENT_FILTER+           98)
    #(+SC-TRACE_INHERIT+                99)
    #(+SC-TRACE_LOG+                    100)
    #(+SC-TTY_NAME_MAX+                 101)
    #(+SC-TYPED_MEMORY_OBJECTS+         102)
    #(+SC-V6_ILP32_OFF32+               103)
    #(+SC-V6_ILP32_OFFBIG+              104)
    #(+SC-V6_LP64_OFF64+                105)
    #(+SC-V6_LPBIG_OFFBIG+              106)
    #(+SC-IPV6+                         118)
    #(+SC-RAW_SOCKETS+                  119)
    #(+SC-SYMLOOP_MAX+                  120)
    #(+SC-ATEXIT_MAX+                   107)
