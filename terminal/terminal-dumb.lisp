...
(defmethod terminal-delete-char ((tty terminal-dumb) &optional n)
  (declare (ignore tty n)))
(defmethod terminal-insert-char ((tty terminal-dumb) &optional n)
  (declare (ignore tty n)))
(defmethod terminal-delete-line ((tty terminal-dumb) &optional n)
  (declare (ignore tty n)))
(defmethod terminal-insert-line ((tty terminal-dumb) &optional n)
  (declare (ignore tty n)))
(defmethod terminal-backward ((tty terminal-dumb) &optional n)
  (declare (ignore tty n)))
(defmethod terminal-forward ((tty terminal-dumb) &optional n)
  (declare (ignore tty n)))
(defmethod terminal-up ((tty terminal-dumb) &optional n)
  (declare (ignore tty n)))
(defmethod terminal-down ((tty terminal-dumb) &optional n)
  (declare (ignore tty n)))
(defmethod terminal-scroll-down ((tty terminal-dumb) n) (declare (ignore tty n)))
(defmethod terminal-scroll-up ((tty terminal-dumb) n)   (declare (ignore tty n)))
...
(defmethod terminal-clear ((tty terminal-dumb) &key saved-p)
  (declare (ignore tty saved-p)))
